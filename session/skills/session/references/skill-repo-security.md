...
Read this when running a repo session **load** flow (`start-classic.md` Step 4 / `start-impl.md` Step 4, `switch.md` Step 3) or a session-file **write** flow (`checkpoint`, `finish`, `commit`, `switch`).
...
## Load-time flow (start-classic.md Step 4, switch.md Step 3)
