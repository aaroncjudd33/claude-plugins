...
Whenever any step in this plugin posts a Teams message, apply these rules without exception — they mirror the comms plugin's **two Teams gates** (read-before-post + show-draft-before-send):
...
4. **Follow the HTML guide.** Read `~/.claude/plugins/marketplaces/ajudd-claude-plugins/comms/skills/comms/references/teams-html-guide.md` before drafting any message.
